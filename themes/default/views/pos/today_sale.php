    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-bottom: 1px solid #008d4c;"><h4><?= lang('yape_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #008d4c;"><h4>
                            <span><?= $this->tec->formatMoney($yapesales->paid ? $yapesales->paid : '0.00') . ' (' . $this->tec->formatMoney($yapesales->total ? $yapesales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                    <td style="border-bottom: 1px solid #008d4c;"><h4><?= lang('plin_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #008d4c;"><h4>
                            <span><?= $this->tec->formatMoney($plinsales->paid ? $plinsales->paid : '0.00') . ' (' . $this->tec->formatMoney($plinsales->total ? $plinsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
