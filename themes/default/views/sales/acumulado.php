...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var table = $('#SLData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('sales/get_acumulado');?>', type: 'POST', "data": function ( d ) {
                        ...
                        <table id="SLData" class="table table-striped table-bordered table-condensed table-hover" data-page-length='50'>
                            <thead>
                                ...
                                <tr class="active">
                                    ...
                                    <th class="col-xs-2 col-sm-2 text-left">Fecha</th>
                                    <th class="col-xs-3 col-sm-3 text-left">Producto</th>
                                    <th class="col-xs-2 col-sm-2 text-left">Cantidad</th>
                                    <th class="col-xs-2 col-sm-2 text-left">Total</th>
                                </tr>
...
<script type="text/javascript">
    ...
    function activo1(){
        ...
        var cRutin = '<a href="<?= base_url() ?>sales/acumulado/' + tienda + '/' + desde + '/' + hasta + '/' + producto + '" id="enlace_grilla_compras">Ejecutar</a>'
        console.log(cRutin)
