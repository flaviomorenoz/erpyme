...
<body class="login-page login-page-<?= $Settings->theme_style; ?> rtl rtl-inv">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=base_url();?>"><?= $Settings->site_name == 'SI' ? 'SI<b>POS</b>' : '<img src="'.base_url('uploads/'.$Settings->logo).'" alt="'.$Settings->site_name.'" />'; ?></a>
        </div>
        <div class="login-box-body">
            ...
            <?= form_open("auth/login"); ?>
                ...
                <div class="form-group has-feedback">
                    <input type="text" name="identity" class="form-control" placeholder="<?= lang('email'); ?>" />
            ...
            <div class="">
                <br>
                <p>
                    <a href="#" class="text-primary" data-toggle="modal" data-target="#myModal"><?= lang('forgot_your_password'); ?></a>
                </p>
            </div>
        </div>
