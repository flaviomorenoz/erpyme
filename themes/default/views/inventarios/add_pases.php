<?php
    ...
    if(!isset($tipo_mov)){ $tipo_mov = "";}
    if(!isset($confirmado)){ $confirmado = "0";}
?>
<style type="text/css">
    .mostrada{
        border-style: none;
...
<section class="content">
    ...
    <?= form_open_multipart("inventarios/add_pases", 'class="validation" id="form_compra"'); ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-3 mostrada">
            <label>Fecha:</label>
            <?php
                $ar = array(
                    "name"  =>"fechah",
