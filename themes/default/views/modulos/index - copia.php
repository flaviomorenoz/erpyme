<div class="row">
	<div class="col-xs-12 col-sm-10 col-md-8 col-lg-6" style="margin-left:30px; margin-top:10px; border-style:solid; border-color:rgb(70,120,180); border-width:2px; border-radius:10px;">
...
<?php
	...
	//$cols 			= array("id","name","activo","grupo");
	//$cols_titulos 	= array("id","name","activo","grupo");
