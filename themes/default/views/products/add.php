            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4" style="border-style:solid;">
...
<!-- INICIO PRECIOS POR TIENDA ------->
                                <?php if ($Settings->multi_store) { 
                                        echo "<div id=\"china\" class=\"row\" style=\"border-style:solid; border-color: red;\">\n";
                                ...
                                <?php
                                        ...
                                        echo "<div class=\"row\">\n";
                                        echo "<button type=\"button\" onclick=\"rellenar()\">Rellenar</button>";
                                        echo "<button onclick=\"ampliar()\">Ampliar</button>";
                                        echo "</div>\n";
...
<script type="text/javascript">
    function ampliar(){
        document.getElementById('china').style.height = "800px"
    }
    function rellenar(){
